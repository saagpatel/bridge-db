...
- Current behavior: `uv run --directory /Users/d/Projects/bridge-db python -m bridge_db --log-session-boundary <project>`.
...
- `/Users/d/Projects/Notion/src/notion/bridge-db-sync.ts` reads bridge-db state
  and confirms shipped sync through the bridge-db MCP client. It is not an ad
  hoc SQLite writer.
- `/Users/d/.local/share/personal-ops/app/src/bridge-db.ts` uses bridge-db as
...
rg -n "bridge.db|BRIDGE_DB_DEFAULT_PATH|sqlite3" \
  /Users/d/.claude/hooks /Users/d/Projects/Notion/src /Users/d/.local/share/personal-ops \
