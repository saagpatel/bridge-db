...
async def run_status(*, now: datetime | None = None) -> bool:
    ...
    print(
        ...
        " orphaned_companions="
        f"{summary['signals']['orphaned_legacy_backup_companion_count']},"
        " missing_primaries="
        f"{summary['signals']['missing_legacy_backup_primary_count']},"
        " companion_state="
        f"{summary['signals']['legacy_backup_companion_state']},"
        " legacy_provenance="
        f"{summary['signals']['legacy_backup_provenance_state']}"
    )
...
async def run_dogfood() -> bool:
    ...
    print(
        ...
        " orphaned_companions="
        f"{evidence['migration_backups']['orphaned_companion_count']},"
        f" missing_primaries={evidence['migration_backups']['missing_primary_count']},"
        f" companion_state={evidence['migration_backups']['companion_state']},"
        " legacy_provenance="
